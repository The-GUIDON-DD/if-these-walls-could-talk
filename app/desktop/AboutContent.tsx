...
export function AboutContent({ onOk }: AboutContentProps): ReactNode {
    ...
    const handleScroll = () => {
        ...
        if (scrollableHeight > 0) {
            const calculatedThumbHeight = Math.max(60, (clientHeight / scrollHeight) * trackHeight);
            ...
            <div className="w-full h-full bg-[#F3F5FF] box-border border-r-[3px] border-b-[3px] border-white/50 shadow-[-4px_-4px_0_rgba(0,0,0,0.25)] relative overflow-hidden flex">
                ...
                >
                    ...
                    <p className="font-['Chivo_Mono'] font-medium text-xl leading-none text-[#1A1A2E] mb-[0.75em]">
                        Former University Office on Decorum and Investigation (UODI) Co-Chairperson Socorro Escarez states that the University envisions the concept of{" "}
                        <a href="https://www.ateneo.edu/central/gender/ugdo/laws" className="text-[#3B52D4] underline decoration-[#3B52D4] hover:opacity-80">
                            safe spaces
                        </a>{" "}
                        as the “pre-requisite condition” for building a culture of trust, respect, and inclusion. She emphasizes that safe spaces require a{" "}
                        <a href="https://www.ateneo.edu/central/policies/code-of-decorum" className="text-[#3B52D4] underline decoration-[#3B52D4] hover:opacity-80">
                            zero-tolerance policy
                        </a>{" "}
                        against all forms of sexual and gender-based violence and discrimination.
                    </p>
                    ...
                    <p className="font-['Chivo_Mono'] font-medium text-xl leading-none text-[#1A1A2E] mb-[0.75em]">
                        ...
                        within the academe, there remains a need to examine whether current procedures and student experiences reflect the values safe spaces are meant to uphold.
                    </p>

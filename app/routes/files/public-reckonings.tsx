function StepContainer({ title, desc }: { title: string; desc: string }) {
	return (
		<article className="grow flex flex-col items-center gap-10">
			<img src="/files/public-reckonings/Check.svg" alt="Check" />
			<h3 className="text-white font-medium text-3xl text-center h-20">
				{title}
			</h3>
			<section className="w-full flex items-center justify-center p-10 h-50 rounded-2xl border-white border-3">
	...
	return (
		<main className="w-full flex flex-col items-stretch mb-50">
			...
			<section className="mt-10">
				...
				<section className="w-full flex gap-15 my-25">

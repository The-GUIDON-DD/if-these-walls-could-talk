...
export default function ProcedureHesitationContent(): ReactNode {
	...
	return (
		<div className="w-full h-full flex flex-col font-['Chivo_Mono'] select-none text-white overflow-hidden relative">
			<div className="flex-1 overflow-y-auto flex flex-col items-center justify-start text-center">
				<div className="max-w-3xl space-y-8 my-auto">
					...
					<div className="space-y-6 text-base md:text-lg leading-relaxed font-sans text-left text-[#BACBFF] ">
						<p>
							Taking the step to report is only the beginning. Once a complaint
							is filed, many survivors confront a deeper challenge: the
							hesitation to continue pursuing the complaint. This does not come
							from weakness but reflects the emotional and practical weight of
							entering a process that can feel overwhelming.
						</p>
						<p>
							...
							carefully consider before deciding how to proceed. She emphasizes
							that readiness cannot be imposed by institutions and should
							instead come from the survivors themselves. Building on this,
							Ofreneo notes that the pace of reporting is closely tied to a
							survivor’s sense of safety and trust in the process itself. While
							some may feel prepared to act immediately, others need time to
							rebuild confidence in the system and in the support structures
							around them. Respecting this pace, she notes, is part of the
						...
						<p>
							...
							(CASMV), a student-led body under the Sanggunian, provides
							peer-level assistance through its{" "}
							<a
								href="https://www.facebook.com/share/p/1CURsnxbhM/"
								target="_blank"
								rel="noopener noreferrer"
							...
							University offices, making the first step toward reporting feel
							more accessible.
						</p>
						<div className="w-full max-w-[961px] bg-[#F5FF64] text-[#000000] p-[20px] md:pt-[36px] md:pb-[36px] md:px-[63px] border-r-[4px] border-b-[4px] border-[#000000] shadow-[inset_4px_4px_0px_#FFFFFF] font-sans">
							<p className="!text-black">
								...
								complaint, pause the process, or pursue other forms of support.
								For her, keeping these decisions with the survivor helps prevent
								additional harm and allows them to engage with the process in
								ways that feel safe.
							</p>
						</div>
						<p>
							However, even with these mechanisms, societal attitudes continue
							to shape how survivors experience the process. Broader societal
							attitudes, such as{" "}
							<a
							...
							remain strong deterrents, discouraging many from speaking out
					...
					<div className="relative w-full h-[350px] flex items-center justify-center my-12">
						<div className="relative flex flex-col items-center">
							<div
								...
								style={{
									background:
										"linear-gradient(180deg, #C2CCFF 0%, #8593DC 100%)",
								}}
							/>
							<div
					...
					<div className="space-y-6 text-base md:text-lg leading-relaxed font-sans text-left text-[#BACBFF]">
						<div className="space-y-6 text-base md:text-lg leading-relaxed font-sans text-left text-[#BACBFF]">
							<p>
								Escarez explains that a survivor’s immediate environment plays a
								significant role in this hesitation. She explains that
								conversations around sexual misconduct remain taboo in many
								Filipino households, particularly among older generations,
								making disclosure difficult even within one’s own family. In
								some cases, she acknowledges that these experiences are
								minimized, with responsibility shifting onto the victim, which
								further discourages individuals from coming forward.
							</p>
							<p>
								Within this context, Ofreneo frequently encounters doubts that
								shape survivors’ decisions. She asks,
							</p>
						</div>
					</div>
					...
					<div className="w-full max-w-[961px] bg-[#BACBFF] text-[#161B3F] p-[20px] md:py-[20px] md:px-[32px] border-t-[4px] border-l-[4px] border-[#1E3293]/50 border-r-[4px] border-b-[4px] border-[#1E3293] shadow-[4px_4px_0px_rgba(0,0,0,0.25)] font-sans">
							...
							<div
								...
								className={`p-4 font-semibold text-lg flex items-center justify-between cursor-pointer ${
									hoveredIndex === 0 || hoveredIndex === null
										? "bg-[#254EDF] text-white shadow-[inset_2px_2px_0px_rgba(0,0,0,0.3)]"
										: "bg-[#F4F7FF] text-[#161B3F]"
								}`}
							>
						...
						<div className="space-y-6 text-base md:text-lg leading-relaxed font-sans text-left mt-6">
							<p className="!text-[#161B3F]">
								These questions, she adds, weigh heavily on those considering
					...
					<div className="space-y-6 text-base md:text-lg leading-relaxed text-[#BACBFF] font-sans text-left">
						<p>
							...
							that stigma and disbelief remain among the main reasons survivors
							choose not to report. Legal protections may exist, but the{" "}
							<a
						...
						<p>
							Within institutional settings, this tension is also reflected in
							how accountability is framed by the University. Approaches that
							prioritize rehabilitation are intended to address harmful
							behavior, but when they are perceived as operating without clear
							consequences, survivors may question whether justice is truly
							being served.
						</p>

						<p>
							For Selena, hesitation was shaped by these concerns about
							accountability. She recalled her father asking what would happen
							to the student who had harassed her. “They told [my father] that
							the Ateneo isn’t the kind of institution that likes to punish its
							students,” she says, referring to the administrators handling her
							case.
						</p>
					</div>
					...
					<div className="w-full mt-8 p-6 md:p-8 flex flex-col md:flex-row gap-6 md:gap-8 items-start md:items-center text-left bg-[linear-gradient(90deg,#6D91FE_0%,rgba(15,26,79,0.1)_100%)]">
						...
						<div className="flex flex-col text-left space-y-4 flex-1">
							...
							<p className="text-base md:text-lg leading-relaxed text-white font-sans">
								According to her, administrators explained that the University
								believes in giving second chances and providing therapy to
								reform behavior. Her father, she adds, was uneasy at the thought
								that the person who harmed her might remain on campus “just
								hoping to change.”
							</p>
						</div>
					</div>
					...
					<div className="space-y-6 text-base md:text-lg leading-relaxed text-[#BACBFF] font-sans text-left">
						<p>
							In response, the University has begun strengthening its existing
							systems for care and accountability. Through the UGH, faculty and
							staff{" "}
							<a
							...
							regular gender-sensitivity training, while procedures for
							accompaniment continue to be reviewed and refined based on student
							needs.
						</p>

						<p>
							Alongside these efforts, Ofreneo shares that the administration
							has initiated a review of the Code and Rules on Sexual Misconduct
							to ensure that current policies remain relevant to the community’s
							needs.
						</p>

						<p>
							Still, rather than relying on policy alone, Ofreneo emphasizes
							that creating a safe Ateneo requires shared responsibility. She
							highlights that every member of the community plays a role in
							challenging harmful behavior, supporting survivors, and
							maintaining boundaries that protect others.
						</p>

						<p>
							With this, the University’s commitment to safe spaces must
							therefore be reflected not only in written protocols but also in
							daily practice. Mutual respect, active awareness, and consistent
							care form the groundwork of an environment where survivors can

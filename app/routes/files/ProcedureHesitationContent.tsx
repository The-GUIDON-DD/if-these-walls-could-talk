	...
	return (
		<main id="procedure-hesitation" className="file-main">
			...
			<div className="space-y-6 text-base md:text-lg leading-relaxed font-sans text-left text-[#BACBFF] ">
				...
				<div className="w-full bg-[#F5FF64] text-[#000000] p-[20px] md:pt-[36px] md:pb-[36px] md:px-[63px] border-r-[4px] border-b-[4px] border-[#000000] shadow-[inset_4px_4px_0px_#FFFFFF] font-sans">
			...
			<div className="space-y-6 text-base md:text-lg leading-relaxed font-sans text-left text-[#BACBFF]">
				<div className="space-y-6 text-base md:text-lg leading-relaxed font-sans text-left text-[#BACBFF]">
					<p>
						...
						particularly among older generations, making disclosure difficult
						even within one’s own family. In some cases, she acknowledges that
						these experiences are minimized, with responsibility shifting onto
						the victim, which further discourages individuals from coming
						forward.
					</p>
					<p>
			...
			<div className="space-y-6 text-base md:text-lg leading-relaxed text-[#BACBFF] font-sans text-left">
				...
				<p>
					...
					accountability. She recalled her father asking what would happen to
					the student who had harassed her. “They told [my father] that the
					Ateneo isn’t the kind of institution that likes to punish its
			...
			<div className="space-y-6 text-base md:text-lg leading-relaxed text-[#BACBFF] font-sans text-left">
				...
				<p>
					...
					initiated a review of the Code and Rules on Sexual Misconduct to
					ensure that current policies remain relevant to the community’s needs.
				</p>
				...
				<p>
					...
					behavior, supporting survivors, and maintaining boundaries that
					protect others.
				</p>

				<p>
					With this, the University’s commitment to safe spaces must therefore
					be reflected not only in written protocols but also in daily practice.

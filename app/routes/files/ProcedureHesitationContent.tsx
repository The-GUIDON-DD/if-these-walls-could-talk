...
export default function ProcedureHesitationContent(): ReactNode {
	...
	return (
		<main id="procedure-hesitation" className="file-main">
			...
			<p>
				In her work at the UGH, Ofreneo often sees how filing a formal complaint
			...
			<p>
				...
				first responders. These volunteers listen to disclosures, offer initial
				guidance, and help connect survivors to the appropriate University
				offices, making the first step toward reporting feel more accessible.
			</p>
			<div className="w-[60%] bg-[#F5FF64] text-[#000000] p-[0px] md:pt-[36px] md:pb-[36px] md:px-[63px] border-r-[4px] border-b-[4px] border-[#000000] shadow-[inset_4px_4px_0px_#FFFFFF] font-sans mb-10">
			...
			<p>
				...
				shape how survivors experience the process. Broader societal attitudes,
				such as{" "}
				<a
			...
			<p>
				...
				significant role in this hesitation. She explains that conversations
				around sexual misconduct remain taboo in many Filipino households,
				particularly among older generations, making disclosure difficult even
				within one’s own family. In some cases, she acknowledges that these
				experiences are minimized, with responsibility shifting onto the victim,
				which further discourages individuals from coming forward.
			</p>
			<p>
			...
			<div className="w-full max-w-[961px] bg-[#BACBFF] text-[#161B3F] p-[20px] md:py-[20px] md:px-[32px] border-4 border-[#1E3293]/50 shadow-[4px_4px_0px_rgba(0,0,0,0.25)] font-sans mb-8">
			...
			<p>
				...
				that stigma and disbelief remain among the main reasons survivors choose
				not to report. Legal protections may exist, but the{" "}
				<a
			...
			<p>
				...
				rehabilitation are intended to address harmful behavior, but when they
				are perceived as operating without clear consequences, survivors may
				question whether justice is truly being served.
			</p>
			...
			<p>
				...
				says, referring to the administrators handling her case.
			</p>
			...
			<p>
				In response, the University has begun strengthening its existing systems
				for care and accountability. Through the UGH, faculty and staff{" "}
				<a
				...
				regular gender-sensitivity training, while procedures for accompaniment
				continue to be reviewed and refined based on student needs.
			</p>

			<p>
				Alongside these efforts, Ofreneo shares that the administration has
				initiated a review of the Code and Rules on Sexual Misconduct to ensure
				that current policies remain relevant to the community’s needs.
			</p>

			<p>
				Still, rather than relying on policy alone, Ofreneo emphasizes that
				creating a safe Ateneo requires shared responsibility. She highlights
				that every member of the community plays a role in challenging harmful
				behavior, supporting survivors, and maintaining boundaries that protect
				others.
			</p>

			<p>
				With this, the University’s commitment to safe spaces must therefore be
				reflected not only in written protocols but also in daily practice.

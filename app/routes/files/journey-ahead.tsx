	...
	return (
        ...
        <main id="journey-ahead" className="file-main">
			...
			<p>
				...
				culture of respect and inclusivity, as underscored by Escarez.
			</p>
			<p>
				With the systems in place, she upholds the value of transparency among the
				concerned parties, especially with the rulings and proceedings of the cases
				to secure closure and justice for the complainant.
			</p>
			<p>
				In particular, she believes that the assistance provided by the University
				through the investigation of filed complaints has encouraged many to report
				incidents of harassment.
			</p>
			<p>
				However, with inconsistencies in the publication of sexual harassment reports
				in the University, there exists a gap in identifying the current
				effectiveness of these systems, and it remains unclear whether the community
				remains encouraged to speak up about their concerns.
			</p>
			<p>
				Nevertheless, Ofreneo acknowledges the expanding needs of the Ateneo
				community, especially in fully equipping its members to properly address and
				mitigate cases of sexual misconduct. “The intention is [that University
				systems] are always evolving,” Ofreneo underscores.
			</p>
			<p>
				As offices like the UGH were established only in recent years, she shares
				how its operations are continuously changing and developing through students’
            ...
            <div className="relative z-10 w-[59.01rem] max-w-full mx-auto my-12 md:-translate-x-20 flex flex-col shadow-[0px_6px_0px_rgba(22,27,63,0.3)]">
                ...
                <div className="w-full bg-[#FFFFFF] p-8 md:p-12 border-t-4 border-l-4 border-[#00000040] ">
                    ...
                    In response to the current measures implemented by the Ateneo, Selena stresses the need for the institution to improve its demand for holding perpetrators accountable. She reflects on the need for a balance between formative change and championing discipline for the parties involved in complaint cases to genuinely address such instances.
                    </p>
                </div>
            </div>

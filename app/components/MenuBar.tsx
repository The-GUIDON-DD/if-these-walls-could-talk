				...
				{closeAction !== undefined ? (
					<>
						<button
							type="button"
							onClick={closeAction}
							className="border-l-2 border-gray-300 px-2 h-full flex items-center justify-center"
						>
						...
						<button
							type="button"
							onClick={closeAction}
							className="border-l-2 border-r-2 border-gray-300 px-2 h-full flex items-center justify-center"
						>
							<span>
								<IoMdClose />
							</span>
